...
switched around for now because serial port burned out
...
in ms to speed
 decided to make maxDelay the current speed threshold.
 
 - need to organize methods
----------------------------------------------------------------*/
...
// Kinect Variables
int distanceFromKinect = 45; // distance car follows user
...
int maxDelay = 200; // max time to wait for hall sensor
